...
class Execution:
    def __init__(self, __C):
        self.__C = __C
        self.__C.CKPTS_PATH = "/content/drive/My Drive/test/ckpts/"
        self.__C.RESULT_PATH = '/content/drive/My Drive/test/results_test/'
        self.__C.LOG_PATH = "/content/drive/My Drive/test/logs/"
    ...
    def train(self, dataset, dataset_eval=None):
        ...
        if self.__C.RESUME:
            ...
            optim = get_optim(self.__C, net, data_size, self.__C.LR_BASE)
            ...
            print(optim.lr_base, start_epoch)
        ...
        for epoch in range(start_epoch, self.__C.MAX_EPOCH):
            ...
            for step, (
                ...
                img_bbox_iter = img_bbox_iter.cuda()
                ...
                for accu_step in range(self.__C.GRAD_ACCU_STEPS):
                    ...
                    sub_ans_iter = \
                        ans_iter[accu_step * self.__C.SUB_BATCH_SIZE:
                                 (accu_step + 1) * self.__C.SUB_BATCH_SIZE]
                    sub_img_bbox_iter = \
                        img_bbox_iter[accu_step * self.__C.SUB_BATCH_SIZE:
                                 (accu_step + 1) * self.__C.SUB_BATCH_SIZE]
