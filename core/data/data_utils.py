...
def img_feat_load(path_list):
    ...
    for ix, path in enumerate(path_list):
        ...
        iid_to_bbox[iid] = img_feat_bbox
        iid_to_image_w[iid] = img_feat_image_w
        iid_to_image_h[iid] = img_feat_image_h
        print('\rPre-Loading: [{} | {}] '.format(ix, path_list.__len__()), end='          ')

    return iid_to_feat, iid_to_bbox, iid_to_image_w, iid_to_image_h
